...
if(isset($_POST['submit'])){
  ...
  $q = "SELECT * FROM user ORDER BY nomoridentitas DESC LIMIT 1";
  ...
  if(empty($nama) || empty($id) || empty($password) || empty($peran)){
      ...
      if($peran !=1 && $peran != 7){
        $con->query("INSERT INTO `tpkp` (`nomoridentitastpkp`, `namatpkp`, `passwordtpkp`, `id_perantpkp`) VALUES ('$id', '$nama', '$hash', '$peran')");
      }
